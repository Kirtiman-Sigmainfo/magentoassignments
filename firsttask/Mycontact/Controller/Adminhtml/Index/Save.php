...
use firsttask\Mycontact\Model\Mycontact;
   ...
   //  protected $filter;
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('firsttask\Mycontact\Model\Mycontact')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('firsttask_mycontacts');
            ...
            $this->dataPersistor->set('firsttask_mycontacts', $data);
